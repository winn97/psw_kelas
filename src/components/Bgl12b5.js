  ...
  return (
    <div className="bab4-container">
      ...
      Pembelahan sel merupakan suatu proses reproduksi sel gunamemperbanyak jumlah sel dan mempermudah fungsi dari sel itusendiri. #ilihat dari prosesnya pembelahan sel dibagi atas dua yaitu :
        ...
        <img src="bab5.1.png" alt="mitosis" className="section-image" />
        <p>
        ...
        <img src="bab5.2.png" alt="Struktur Penyerapan Makanan" className="section-image" />
      </section>
...
<img src="bab5.4.png" alt="Hukum Mendel" className="section-image" />
...
<img src="bab5.5.png" alt="Pola Pewarisan Sifat" className="section-image" />
...
<img src="bab5.6.png" alt="DNA dan RNA" className="section-image" />
