  ...
  return (
    <div className="bab7-container">
      ...
      <section>
        <h2>Evolusi</h2>
        <p>
        Evolusi (dalam kajian biologi) atau ubah angsur berarti perubahan pada sifat-sifat terwariskan suatu populasi organisme dari satu generasi ke generasi berikutnya.
        </p>
        <img src="bab7.1.webp" alt="Hormon dalam Reproduksi" className="section-image" />
      </section>
      
      <section>
        <h3>Pengertian Evolusi</h3>
        <p>
        ...
        <img src="bab7.2.webp" alt="Ilustrasi Evolusi" className="section-image" />
      </section>

      <section>
        <h3>Evolusi Kehidupan</h3>
        <p>
        ...
        <img src="bab7.3.jpg" alt="Kehamilan" className="section-image" />
        <p>
      ...
      <section>
        <h3>Perkembangan Teori Evolusi</h3>
        <p>
          Perkembangan teori evolusi dimulai dari masa Yunani kuno dan terus berkembang hingga saat ini.
        </p>
        <h4>1. Plato (427-347 SM) </h4>
        <p>
          Plato menyatakan percaya pada dunia, yakni dunia yang ideal dan abadi serta dunia maya (khayal) yang tidak sempurna. Kedua dunia tersebut dapat dipahami dengan menggunakan indera manusia. Dikatakan evolusi akan mengubah dunia yang organismenya sudah ideal dan beradaptasi sempurna dengan lingkungan.
        </p>

        <h4>2. Aristoteles (384-322 SM) </h4>
        <p>
          Aristoteles menganut teori skala alami. Dikutip situs Kementerian Pendidikan dan Kebudayaan (Kemendikbud), teori yang disampaikan Aristoteles membahas bahwa semua bentuk kehidupan disusun menurut suatu skala atau tangga yang kompleksitasnya meningkat ke atas. Menurutnya, setiap bentuk kehidupan makhluk hidup mempunyai suatu tangga dengan anak tangga masing-masing yang ada pada tingkatan yang berbeda.
        </p>

        <h4>3. Jean Baptise de Lamarck (1744-1829)</h4>
        <p>
          Pada teori evolusi Lamarck ada dua gagasan utama, yakni:Memiliki dua gagasan mengenai evolusi. Gagasan pertama berkaitan dengan bagian tubuh yang digunakan dan tidak digunakan oleh makhluk hidup. Melalui gagasannya ini, ia menganggap bahwa bagian tubuh yang terus-menerus dipakai makhluk hidup dalam menghadapi lingkungan tertentu akan menjadi lebih besar dan lebih kuat dibandingkan anggota tubuh yang jarang digunakan. 
          <br />
          Sementara anggota tubuh yang jarang digunakan akan mengalami kemunduran. Gagasan kedua Lamarck berkaitan dengan pewarisan sifat atau ciri-ciri yang diperoleh makhluk hidup dalam beradaptasi dengan lingkungannya. Pewarisan sifat atau ciri-ciri inilah yang memodifikasi organisme yang diperolehnya selama hidupnya. Contohnya, jerapah yang disebut berleher pendek, tapi karena lehernya terus menerus menjulur untuk mendapatkan daun di pohon yang tinggi, leher jerapah mulai menjadi panjang. Leher panjang inilah yang diwariskan ke semua keturunannya.
        </p>
        <img src="https://i.pinimg.com/736x/3e/dc/db/3edcdbaaa90218b00127feb7bdcb3380.jpg" alt="Evolusi" className="section-image" />
      </section>

      <section>
        <h4>4. Charles Robert Darwin (1809-1882) </h4>
        <img src="https://mmc.tirto.id/image/2024/02/04/ilustrasi-gambar-teori-evolusi-kimia-istock_ratio-16x9.jpg" alt="Evolusi" className="section-image" />
        <p>
