...
import '../css/Bgl12b2.css';

const Bab2 = () => {
  const navigate = useNavigate();
  return (
    <div className="bab2-container">
      <h1>Bab 2: Enzim dan Metabolisme Organisme</h1>

      <section>
        <h2>1.Apa itu Metabolisme?</h2>
        <p>
...
2. Gugus non protein : yaitu bagian dari enzim yang tersusun dari senyawa non protein<br />
 ...
 Enzim memiliki sisi aktif, yakni bagian atau tempat pada enzim yang berfungsi sebagai tempat menempelnya substrat. Kerja enzim sangat spesifik karena sisi aktif dari enzim sangat selektif terhadap bentuk kimia dari substrat yang akan dikatalisis. Ikatan yang terbentuk antara enzim dengan substrat bersifat lemah sehingga reaksi dapat berlangsung bolak-balik. Substrat menempel pada sisi aktif enzim dan akan menghasilkan produk baru. Komponen nonprotein/gugus prostetik memiliki sifat stabil pada suhu yang relative tinggi dan tidak berubah pada akhir reaksi. Gugus prostetik di bedakan menjadi kofaktor dan koenzim. Kofaktor tersusun dari zat anorganik yang umumnya logam misalnya Cu, Fe, Mn, Zn, Ca, K dan Co. Koenzim tersusun dari senyawa organic nonprotein yang idak melekat erat pada bagian protein enzim, misalnya vitamin, NAD, NADP dan Koenzim A.
      ...
      <section>
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_-lo9t91_RP6STjgyPyGtzOJHwWDB0YoI_A&s" className="section-image" />

        <h3>b. Karbohidrase</h3>
        <p>
...
3.Sukrase, merupakan enzim yang mengubah sukrosa (gula tebu) menjadi glukosa dan fruktosa.
        ...
        <img src="https://i.pinimg.com/736x/ab/1a/56/ab1a56c4b9c1a73236a46af73d8e3914.jpg"className="section-image" />
        <h3>c. Esterase</h3>
        <p>
...
2.Fosfatase, adalah enzim yang memproses suatu ester hingga terlepas asam fosfat.
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROB8e8BpIdQ9EdDUvNLsnznnV0h_VmNQgO_Q&s"className="section-image" />
        <h3>d. Proteinase atau Protease</h3>
        <p>
...
3.Renin adalah enzim yang memecah kasein dari susu.
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEiWoReWUhaDKJOHkuAOFznoqa8wwuHf6IRg&s"className="section-image" />
        <h3>e. Oksidase dan Reduktase</h3>
        <p>
...
Katalase adalah enzim yang dapat melakukan penguraian terhadap hidrogen peroksida menjadi oksigen serta air.
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-gYgaGRRFRBlCAt70lYa6xhWYGuEsbzUEiQ&s"className="section-image" />
        <h3>f. Desmolase</h3>
        <p>
...
Transaminase yaitu enzim yang memindahkan gugusan amino dari suatu asam amino ke suatu asam organic sehingga yang terakhir ini berubah menjadi suatu asam amino.<br />
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCrr7RJ5IkshIQhpvJSqANYkwNDNfPk_2fKg&s"className="section-image" />
      </section>
 
      <section>
        <h2>4. Faktor yang Mempengaruhi Kerja Enzim</h2>
        <p>
          Beberapa faktor yang mempengaruhi kinerja enzim:
        </p>
        <ul>
          <li>
            <strong>Suhu:</strong> Enzim tersusun dari protein sebab itu enzim sangat peka terhadap suhu. Suhu yang terlalu tinggi dapat menyebabkan denaturasi protein, dan suhu yang terlalu rendah dapat menghambat laju reaksi. Setiap enzim mempunyai suhu optimum yang spesifik, jika enzim berada di bawah suhu optimum maka kerja enzim akan terhambat.
          </li>
          <li>
            <strong>pH:</strong> Setiap enzim mempunyai pH optimun yang spesifik. Perubahan pH mengakibatkan sisi aktif enzim berubah sehingga dapat menghalangi terikatnya substrat pada sisi aktif enzim, selain itu perubahan pH juga mengakibatkan proses denaturasi pada enzim.
          </li>
          <li>
            <strong>Konsentrasi Enzim dan substrat:</strong> Agar reaksi berjalan optimum, perbandingan jumlah antara enzim dan substrat harus sesuai. Jika enzim terlalu sedikit dan substrat terlalu banyak reaksi akan berjalan lambat dan bahkan ada substrat yang tidak terkatalisasi. Semakin banyak enzim maka reaksi akan berjalan semakin cepat.
          </li>
          <li>
            <strong>Zat-zat Pengikat:</strong>
          ...
          <li>
            <strong>Zat-zat Penghambat:</strong>
