...
const Bab4 = () => {
  ...
  return (
    <div className="bab4-container">
      <h1>Bab 4: Limit Trigonometri</h1>

      <section>
        <h2>1. Limit</h2>
        <p>
        Limit fungsi trigonometri merupakan nilai yang diperoleh dari suatu fungsi trigonometri jika variabelnya mendekati nilai tertentu. Limit tersebut juga kerap disebut dengan limit Matematika.
        Singkatnya, limit fungsi trigonometri merupakan nilai terdekat suatu sudut di fungsi trigonometri. Cara menghitungnya mirip seperti limit fungsi aljabar. Perbedaannya yakni fungsi trigonometri wajib diubah terlebih dahulu ke trigonometri agar dapat melihat limit tak tentunya
 </p>
      </section>

      <section>
        <h2>2. Fungsi Trigonometri yang Kerap Digunakan</h2>
        <h3>1. Sinus</h3> 
        <p>
      ...
      <section>
        <h2>3. Manfaat Limit Fungsi Trigonometri</h2>
        <p>
        Manfaat limit fungsi trigonometri yang pertama adalah untuk<strong> Menentukan Batas Integral </strong>sebuah fungsi. Artinya, penentuan pun akan menjadi lebih akurat dan tepat
</p>
        <p>
        Manfaat lainnya yakni terkait <strong>Penyelesaian Persamaan Diferensial. </strong>Limit ini dapat digunakan menyelesaikan persamaan matematika yang menjelaskan perubahan fungsi terhadap waktu maupun variabel lain.
</p>
        <p>
        Manfaat limit fungsi trigonometri yang berikutnya adalah<strong>Membantu Perhitungan menjadi lebih akurat.</strong>Hal tersebut terjadi Khsususnya pada nilai yang sangat dekat dengan batas tertentu.
</p>
<p>
Selain itu terdapat manfaat lain berupa <strong>Memahami Sifat Sebuah Fungsi Trigonometri </strong>Nantinya, dapat disimpulkan bahwa fungsi tersebut terbatas atau tidak terbatas, berubah atau tidak berubah pada nilai tertentu, dan lain sebagainya
</p>

      </section>

      <section>
        <h2>4. Rumus Limit Fungsi Trigonometri</h2>
        <p>
      ...
      <section>
        <h2>5. Rumus Identitas Trigonometri</h2>
        <p>
