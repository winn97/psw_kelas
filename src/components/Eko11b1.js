...
import '../css/Eko11b1.css';

const Bab1 = () => {
  const navigate = useNavigate();
  return (
    <div className="bab1-container">
      <h1>Bab 1: Pengantar Ekonomi</h1>

      <section>
        <h2>1. Pengertian Ekonomi</h2>
        <p>
          Ekonomi adalah ilmu yang mempelajari bagaimana masyarakat mengelola sumber daya yang terbatas untuk memenuhi kebutuhan dan keinginan yang tidak terbatas. 
          Ilmu ekonomi membantu kita memahami proses produksi, distribusi, dan konsumsi barang dan jasa, serta bagaimana keputusan-keputusan ekonomi dibuat.
        </p>
      </section>
