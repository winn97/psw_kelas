...
const Bab4 = () => {
  ...
  return (
    <div className="bab4-container">
      <h1>Bab 4: Tabel Periodik </h1>

      <section>
        <h2>1. Pengertian Tabel Periodik</h2>
        ...
        <p>
        Tabel Periodik Menurut beberapa ilmuwan 
          </p>
        <ul>
          <li>
            <strong>Menurut Antoine Lavoisier:</strong> 
            Aristokrat dan ahli kimia Prancis <strong>Antoine Laurent Lavoisier</strong> adalah tokoh yang sangat penting dalam sejarah kimia.
          ...
          <li>
            <strong>Menurut Johann Wolfgang Dobereiner:</strong> 
            <strong>Wolfgang Johannes Dobereiner</strong>, seorang peneliti kimia dan fisika, menjadi pencipta konsep
      ...
      <section>
        <h2>2. Jenis-Jenis Unsur pada Tabel Periodik</h2>
        <p>
      ...
      <section>
        ...
        dan deret aktinida-lantanida.</h2>
        <p>
        <strong> A. Logam utama </strong>, Unsur logam utama berada di golongan A,
      ...
      logam utama ini bersifat lebih lunak dengan titik leleh dan titik didih yang relatif lebih rendah.
        ...
        <p>
        <strong> B. Logam transisi </strong>, Logam transisi (ditunjukkan oleh warna ungu) berada di golongan I B – VIII B.
      ...
      sulit untuk bereaksi karena memiliki elektron val ensi lebih banyak.
        ...
        <p>
          <strong> C. Logam post transisi </strong>, Logam post transisi ini berada di antara golongan unsur metaloid 
      ...
      dan sebagainya.
        ...
        <p>
          <strong> D. Deret lantanida dan aktinida </strong>, Kedua deret tersebut termasuk logam, lho. 
      ...
      <section>
        <h2>4. Unsur pada Tabel Periodik</h2>
        <p>
      ...
      <section>
        <h2> 5. Cara Menentukan Golongan dan Periode Unsur pada Tabel Periodik </h2>
        ...
        <h3> Cara Mencari Golongan dan Periode </h3>
        <p>
        ...
        <h3> Berikut beberapa contoh golongan dalam tabel periodik </h3>
        <p>
          <ul>
            <li>
            ...
            <p>
            Unsur-unsur dalam Golongan 1 adalah logam alkali. Mereka sangat reaktif dan terdapat di dalam senyawa ionik. 
          ...
          <p>
          Unsur-unsur dalam Golongan 2 adalah logam alkali tanah. 
          ...
          <p>
          Unsur-unsur dalam Golongan 17 adalah halogen. Mereka sangat reaktif dan cenderung membentuk senyawa ionik.
            dengan logam alkali. 
      ...
      <section>
        <h2> Periode dalam Tabel Periodik </h2>
        <p>
        Periode dalam tabel periodik adalah baris-baris horizontal di tabel. Setiap unsur dalam periode memiliki lapisan elektron yang sama. 
