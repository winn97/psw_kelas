...
import '../css/Bgl12b3.css';

const Bab3 = () => {
  const navigate = useNavigate();
  return (
    <div className="bab3-container">
      <h1>Bab 3: Substansi Materi Genetika</h1>

      <section>
        <h2>Pengertian Materi Genetik</h2>
        <p>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/pRLzqHAWTcs?si=ao_h2E-SI8mTirTa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </section>
      ...
      <section>
        ...
        <h3>Genetika Menurut James Watson</h3>
        <p>
        ...
        <img src="bab3.1.JamesW.webp" alt="James Watson" className="section-image" />

        <h3>Genetika Menurut Francis Crick</h3>
        <p>
        ...
        <p>
          ...
          <ul>
            <li>Bahan pembawa informasi untuk diwariskan (bahan genetik)</li>

            <li>Bagaimana informasi yang diungkapkan (ekspresi gen)</li>

            <li>Bagaimana informasi dibagikan dari satu orang ke orang lain (warisan genetik).</li>
          </ul>
        </p>
        <img src="bab3.2.FrancisC.webp" alt="Francis Crick" className="section-image" />

        <h3>Istilah-istilah dalam Genetika</h3>
        <p>
          ...
          <ul>
            <li><strong>Kromosom</strong>: Kromosom merupakan struktur dalam inti sel yang terdiri dari DNA yang terikat dengan histon dan protein lainnya.</li>
            <li><strong>Alel</strong>: Bentuk alternatif dari sebuah gen dalam suatu lokus.</li>
            <li><strong>Gen</strong>: Pewaris bagi organisme hidup.</li>
            <li><strong>Gonosom</strong>: Semua kromosom yang ada, selain kromosom kelamin.</li>
            <li><strong>Autosom</strong>: Gonosom (biasa disebut kromosom kelamin) yang hanya ada dalam sel gamet.</li>
            <li><strong>Parental (p)</strong>: Alur hidup seseorang berdasarkan garis keturunan ayah/ibu atau penerus keturunan dalam setiap spesies.</li>
            <li><strong>Filial (F)</strong>:  Keturunan yang diperoleh melalui perkawinan parental.</li>
            <li><strong>Haploid</strong>: Individu yang terdapat separuh jumlah genom sel normal, dilambangkan dengan x = n.</li>
            <li><strong>Diploid</strong>: Sebutan untuk sel atau individu yang memiliki sel dengan dua set genom.</li>
            <li><strong>Dominan</strong>: Gen dapat disebut dominan, apabila gen tersebut bersama dengan gen lain (gen pasangannya) akan menutup peran/sikap gen pasangannya tersebut.</li>
            <li><strong>Resesif</strong>: Gen dikatakan resesif apabila berpasangan dengan gen lain yang dominan, ia akan tertutup sikapnya. Tetapi, jika dengan gen resesif lainnya (alelanya) sifatnya akan muncul.</li>
            <li><strong>Genotif</strong>: Susunan gen yang menentukan sikap dasar suatu makhluk hidup dan bersifat tetap.</li>
            <li><strong>Fenotif</strong>: Sifat yang tercipta dari suatu individu dan dapat diamati oleh panca indra, misalnya bentuk tubuh, rasa asin dan rambut keriting.</li>
          </ul>
        </p>
      ...
      <section>
        ...
        <p>
          ...
          <ul>
            <li>Transkripsi, proses pembuatan salinan RN</li>
            <li>Translasi, proses sintesis polipeptida yang spesifik di dalam ribosom.</li>
          </ul>
          <br/>
      ...
      <section>
        ...
        <p>Fungsi Kromosom diantaranya Sebagai tempat penyimpanan informasi genetik yang akan diturunkan dari induk ke anak sampai membentuk sifat dan ciri khas individu itu. Berperan penting dalam proses pembelahan sel.</p>

        <h3>Struktur Bagian Kromosom diantaranya:</h3>
        <p>
          <ul>
            <li>Sentromer : Bagian pusat kromosom yang bisanya berbentuk bulat. Pada sentromer ada kinetokor mempunyai fungsi penting saat terjadinya pembelahan sel. Pada bagian inilah benang spindel melekat kepada masing-masing kutub yang berlawanan.</li>
            <li>Kromatid : salah satu dari kedua lengan hasil replikasi pada kromosom. Pada lengan kromosom ada kromonema, yakni pita yaang berbentuk spiral. Pada kromonema bisa terlihat penebalan berupa manik-manik yang disebut Kromomer. Biasanya kromomer susah untuk diamati, tapi bisa terlihat jelas pada kromosom yang sudah banyak melakukan replikasi. Kromonema dibungkus oleh substansi khusus yang disebut matriks. Kromatid melekat satu sama lain kepada bagian sentromer.</li>
          </ul>
        </p>
        ...
        <p>
          <ul>
            <li>Telomer : istilah yang dipakai untuk menunjukkan bagian ujung dari kromosom. Telomer berfungsi untuk menjaga DNA pada bagian ujung tak terurai serta mencegah bertemunya satu lengan dengan lengan kromosom yang lainnya. Telomer pun berfungsi untuk melindungi kromosom dari ancaman lingkungan.</li>
            <li>Kromomer : struktur berbentuk manik-manik yang merupakan akumulasi dari materi kromatin yang kadang terlihat saat interfase. Kromomer sangat jelas terlihat pada kromosom politen (kromosom dengan DNA yang sudah direplikasi berulang kali tanpa adanya pemisahan dan terletak berdampingan sampai bentuk kromosom seperti kawat).</li>
            <li>Satelit : bagian kromosom yang berbentuk bulatan dan berada di ujung lengan kromatid.Satelit terbentuk karena adanya konstriksi sekunder di daerah itu.</li>
          </ul>
        </p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/fWeDzRo4lRA?si=QuuNvbWhxGFG4brv" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </section>

      <section>
        <h2>Susunan Kromosom</h2>
        <p>
        ...
        <img src="https://asset.kompas.com/data/photo/2020/12/30/5fec713595bda.png" alt="Kromosom" className="section-image" />
        ...
        <img src="bab3.9.jpg" alt="Pembuahan dan Perkecambahan" className="section-image" />
      </section>
