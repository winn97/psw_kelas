...
import '../css/Kma12b4.css';

const Bab1 = () => {
  const navigate = useNavigate();
  return (
    <div className="bab1-container">
      <h1>Bab 4: Senyawa Karbon dan Turunan Alkanaa</h1>
      <p>
      ...
      <img
        ...
        alt="Senyawa turunan Alkana" className="section-image"/>
      <section>
        <h2>1. Alkohol</h2>
        ...
        <h4>Metanol</h4>
          <p>Alkohol merupakan salah satu senyawa karbon yang memiliki berbagai kegunaan dalam kehidupan sehari-hari maupun industri. Berikut adalah beberapa kegunaan alkohol:</p>
            <ul>
              <li><strong>Pelarut:</strong> Alkohol, seperti etanol, sering digunakan sebagai pelarut untuk melarutkan zat-zat yang tidak dapat larut dalam air.</li>
              <li><strong>Bahan bakar:</strong> Metanol dan etanol digunakan sebagai bahan bakar alternatif yang ramah lingkungan.</li>
              <li><strong>Disinfektan:</strong> Alkohol memiliki sifat antiseptik dan digunakan untuk membunuh kuman pada luka atau permukaan benda.</li>
              <li><strong>Minuman:</strong> Etanol digunakan dalam pembuatan minuman beralkohol seperti bir, anggur, dan wiski.</li>
              <li><strong>Industri kosmetik:</strong> Alkohol digunakan dalam produk kosmetik, seperti parfum dan lotion, untuk membantu pencampuran bahan.</li>
              <li><strong>Farmasi:</strong> Alkohol digunakan sebagai pelarut dalam obat-obatan cair dan sebagai bahan baku dalam sintesis senyawa farmasi.</li>
              <li><strong>Industri kimia:</strong> Alkohol merupakan bahan baku dalam pembuatan senyawa kimia lain, seperti ester dan asam karboksilat.</li>
            </ul>
        <h4>Etanol</h4>
        <ul>
        ...
        <p><strong>3. Propan-2-ol</strong></p>
          <ul>
      ...
      <section>
        ...
        <img
            ...
            alt="Reaksi dengan Asam Sulfat dan Etanol" className="section-image"/>
        ...
        <ul>
          ...
          <img
            ...
            alt="Kegunaan Eter" className="section-image"/>
      </section>
      ...
      <section>
        ...
        <p>Aldehid merupakan salah satu senyawa karbon yang memiliki banyak kegunaan dalam kehidupan sehari-hari dan industri. Berikut adalah beberapa kegunaan aldehid:</p>
          <ul>
              <li><strong>Pembuatan parfum:</strong> Beberapa aldehid, seperti benzaldehida, digunakan sebagai bahan penyedap aroma dalam parfum dan kosmetik.</li>
              <li><strong>Penyedap makanan:</strong> Aldehid seperti vanilin digunakan untuk memberikan rasa dan aroma pada makanan dan minuman.</li>
              <li><strong>Bahan baku industri:</strong> Formaldehida digunakan dalam pembuatan resin, plastik, dan bahan perekat.</li>
              <li><strong>Pengawet:</strong> Formaldehida digunakan sebagai bahan pengawet dalam industri farmasi dan laboratorium.</li>
              <li><strong>Sintesis senyawa organik:</strong> Aldehid berperan sebagai bahan antara dalam sintesis senyawa organik lain, seperti asam karboksilat dan alkohol.</li>
              <li><strong>Fotografi:</strong> Aldehid seperti glutaraldehida digunakan dalam proses pengembangan foto.</li>
              <li><strong>Industri farmasi:</strong> Aldehid digunakan dalam produksi obat-obatan, seperti obat anti-malarial dan obat antimikroba.</li>
          </ul>
      </section>
      ...
      <section>
        ...
        <p><strong>Oksidasi Alkohol Sekunder</strong></p>
          <img
      ...
      <section>
        ...
        <ul>
          ...
          <img
            ...
            alt="Oksidasi Alkohol Primer" className="section-image"/>
          ...
          <img
            ...
            alt="Oksidasi Keton" className="section-image" />
        </ul>
      ...
      <section>
        ...
        <img
          ...
          alt="Pembuatan Ester" className="section-image" />
      ...
      <section>
        ...
        <img
          ...
          alt="Rumus Struktur Kloroform" className="section-image"/>
        ...
        <img
          ...
          alt="Karbon Tetraklorida" className="section-image" />
        ...
        <img
          ...
          alt="Fosgen" className="section-image"/>
        ...
        <img
          ...
          alt="Fosgen2" className="section-image"/>
      </section>
      <section className="Contoh-soal-Senyawa">
        ...
        <img
          ...
          alt="Soal2" className="section-image"/>
        ...
        <img
          ...
          alt="Kunci2" className="section-image" />
      </section>
      ...
      <div className="bottom-container">
        ...
        <button 
          ...
          onClick={() => window.location.href = "/SlKma12b4"}
        >
          Mulai Latihan Soal
        </button>
      </div>
