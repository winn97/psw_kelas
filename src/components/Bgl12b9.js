  ...
  return (
    <div className="bab8-container">
      ...
      <section>
        ...
        <img src="https://umsu.ac.id/artikel/wp-content/uploads/2023/07/Mutasi-Genetik.jpg" alt="Ilustrasi Mutasi" className="section-image" />
      ...
      <section>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/gT802RtHYk8?si=2OfT_Kt-7lMlhTOq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        <ul>
          <li>Materi Genetik</li>
            <p>
              Syarat utama mutasi adalah adanya materi genetik yang mengalami perubahan. Materi genetik ini terdiri dari DNA (asam deoksiribonukleat) pada organisme eukariotik dan prokariotik. Perubahan pada urutan DNA dapat menyebabkan perubahan pada sifat-sifat organisme.
            </p>
      ...
      <section>
        ...
        <img src="https://asset.kompas.com/data/photo/2020/11/08/5fa7ead1caf2a.jpg" alt="Mutasi" className="section-image" />
        ...
        <img src="https://asset.kompas.com/data/photo/2020/11/08/5fa7eb234390c.jpeg" alt="Mutasi" className="section-image" />
      </section>
