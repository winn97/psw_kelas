...
import '../css/Eko11b11.css';

const Bab11 = () => {
  const navigate = useNavigate();
  return (
    <div className="bab11-container">
      <h1>Bab 11: Kebijakan Ekonomi</h1>
      ...
      <section>
        ...
        <p>
          Pengertian: Kebijakan yang berkaitan dengan pengelolaan anggaran pemerintah melalui pengeluaran dan penerimaan negara (pajak).
        </p>
        <ul>
          <li><strong>Tujuan:</strong> Mendorong pertumbuhan ekonomi, mengendalikan inflasi, mengurangi pengangguran, dan menciptakan distribusi pendapatan yang lebih merata.</li>
          <li><strong>Alat-Alat Kebijakan Fiskal:</strong> Pengeluaran Pemerintah, Pajak.</li>
        </ul>

        <h3>b. Kebijakan Moneter</h3>
        <p>
          Pengertian: Kebijakan yang berkaitan dengan pengelolaan jumlah uang beredar dan tingkat suku bunga oleh bank sentral.
        </p>
        <ul>
          <li><strong>Tujuan:</strong> Mengendalikan inflasi, menjaga stabilitas nilai tukar, dan mendorong pertumbuhan ekonomi.</li>
          <li><strong>Alat-Alat Kebijakan Moneter:</strong> Operasi Pasar Terbuka, Suku Bunga, Rasio Cadangan Wajib.</li>
        </ul>

        <h3>c. Kebijakan Perdagangan</h3>
        <p>
          Pengertian: Kebijakan yang mengatur hubungan perdagangan internasional untuk mendukung perekonomian domestik.
        </p>
        <ul>
          <li><strong>Tujuan:</strong> Meningkatkan ekspor, melindungi industri domestik, dan menjaga keseimbangan neraca perdagangan.</li>
          <li><strong>Alat-Alat Kebijakan Perdagangan:</strong> Tarif, Kuota, Subsidi Ekspor.</li>
        </ul>

        <h3>d. Kebijakan Industri</h3>
        <p>
          Pengertian: Kebijakan yang bertujuan untuk mengembangkan sektor-sektor industri strategis dalam perekonomian.
        </p>
        <ul>
          <li><strong>Tujuan:</strong> Meningkatkan daya saing industri, menciptakan lapangan kerja, dan mengurangi ketergantungan pada impor.</li>
          <li><strong>Alat-Alat Kebijakan Industri:</strong> Subsidi, Insentif Pajak, Regulasi.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          Implementasi kebijakan ekonomi melibatkan beberapa langkah, termasuk:
        </p>
        <ul>
      ...
      <section>
        ...
        <ul>
          <li><strong>Amerika Serikat:</strong> Penerapan kebijakan fiskal dan moneter yang agresif selama krisis finansial 2008 untuk mengatasi resesi dan mendorong pertumbuhan ekonomi.</li>
          <li><strong>Cina:</strong> Kebijakan industri yang fokus pada pengembangan teknologi tinggi dan manufaktur untuk meningkatkan daya saing global.</li>
          <li><strong>Indonesia:</strong> Kebijakan fiskal yang mencakup program subsidi untuk sektor pertanian dan infrastruktur untuk mendorong pembangunan ekonomi daerah.</li>
        </ul>
      </section>
      ...
      <div className="bottom-container">
        ...
        <button 
          ...
          onClick={() => window.location.href = "/latihansoal11"}
        >
          Mulai Latihan Soal
        </button>
      </div>
